...
const brandColors = {
  primaryPurple: "rgb(74, 222, 128)", // Verde chicle (antes morado principal)
  ...
  return (
    <div className="py-20" id="servicios">
      ...
      <div className="absolute inset-0 z-0 opacity-30 pointer-events-none">
        <div className="absolute top-1/4 right-1/4 w-96 h-96 rounded-full" style={{ background: 'radial-gradient(circle, rgba(172, 68, 171, 0.2) 0%, rgba(0, 0, 0, 0.95) 50%)', filter: 'blur(60px)' }} />
        <div className="absolute bottom-1/4 left-1/4 w-96 h-96 rounded-full" style={{ background: 'radial-gradient(circle, rgba(146, 35, 164, 0.2) 0%, rgba(0, 0, 0, 0.95) 50%)', filter: 'blur(60px)' }} />
      </div>
      
      <div className="relative z-10 mb-16">
        <h2 className="text-4xl font-bold text-center mb-4">
          Nuestros <span className="text-verde-chicle">Servicios</span>
        </h2>
